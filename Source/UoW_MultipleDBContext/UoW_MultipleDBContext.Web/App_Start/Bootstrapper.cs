...
namespace UoW_MultipleDBContext.Web
{
    public static class Bootstrapper
    {
        ...
        private static void SetAutofacContainer()
        {
            ...
            builder.RegisterType(typeof(CategoryRepository)).As(typeof(ICategoryRepository)).InstancePerDependency();
            builder.RegisterType(typeof(DepartmentRepository)).As(typeof(IDepartmentRepository)).InstancePerDependency();
